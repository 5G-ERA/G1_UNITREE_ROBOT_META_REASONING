            ...
            if cmd is not None:
                ...
                if c0 <= EXP_FWD_MIN:
                    ...
                    if tgt is not None and plan_pts:
                        ...
                        # v2 VELOCIDAD SEGUN CONFIANZA (metacognicion): frena si el laser ve algo cercano
                        # delante (<1.2m), si la camara ve suelo tapado, o si la camara esta degradada.
                        cautious = ((vision_on and vfresh and cf_cam < 0.45) or c0 < 1.2
                                    or now < vav_suppress_until or (vb and vclose))   # frena tambien si la camara ve algo cerca
                        ...
                        if abs(e) > 55:                               # muy desalineado -> pivota en el sitio
                            ...
                            cmd = (0, spd, turn, 0); ph = "F-ARC"; esc_t0 = 0
                        else:                                         # alineado -> recto
